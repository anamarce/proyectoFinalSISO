...
void dohelp()
{
	...
	printstring("     MKDIR <DIR_NAME>:  Create Directory\r\n\0");
	printstring("     LS <DIR_NAME>:  List Directory\r\n\0");
}
/*
void domkdir(char* dirName)
{
	char* name=getargument(dirName);
	mkdir(name);
}*/
...
void docreate(char* line)
{
	...
	writefile(name,file,mydiv(index,512)+1);
	printstring("\r\n\0");
}
